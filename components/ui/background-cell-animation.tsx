      ...
      {matrix.map((row, rowIdx) => (
        ...
        >
          {row.map((_, colIdx) => {
            ...
            }, [clickedCell]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    >
      <div className="absolute h-[20rem] inset-y-0 overflow-hidden">
        {/* Bottom fade */}
        <div className="absolute h-full w-full pointer-events-none -bottom-2 z-40 bg-[#080808] [mask-image:linear-gradient(to_bottom,transparent,black)]" />

        {/* Revealed blue cells under cursor */}
        <div
